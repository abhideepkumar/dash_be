...
import { getSynthesizeInsightsPrompt } from '../prompts/insightPrompts.js';
...
async function synthesizeInsights(classification, statistics, originalQuery, sampleRows) {
  const prompt = getSynthesizeInsightsPrompt({ originalQuery, classification, statistics, sampleRows });
